...
set -euo pipefail
exec "${KERNEL_BIN:-kernel}" pre-commit --ledger "evidence/events.jsonl" --run-id "${CLAUDE_SESSION_ID:-unbound-$PPID}" --playbook-ref "sha256:d1d481267c1ce4acadd3df9e7ecbbe9c361bf6c21c1204e3473d004ce293b85d" --packet "${INTAKE_ACTIVE_PACKET:-tasks/active.json}" --require require-validation:run
