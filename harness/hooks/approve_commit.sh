...
set -euo pipefail
exec "${KERNEL_BIN:-kernel}" pre-commit --ledger "evidence/events.jsonl" --run-id "${CLAUDE_SESSION_ID:-unknown}" --playbook-ref "sha256:78ed5c3f80459e9fe925aff80293c612572cde3e4679a5429ca17f49e7bdb9fc" --require require-validation
